...
'Form e-mail errors'		=>	'<strong>Upozornění!</strong> Následující chyby musí být opraveny před tím, než může být zpráva odeslána:',
'No e-mail subject'			=>	'Musíte zadat předmět zprávy.',
...
'Write e-mail'				=>	'Napsat e-mail:',
'Send forum e-mail'			=>	'Napište e-mail pro uživatele %s a odešlete ho prostřednictvím fóra',
...
// Hostname lookup
'Hostname lookup'			=>	'IP adresa je: %1$s<br />Jméno host je: %2$s<br /><br />%3$s',
'Show more users'			=>	'Zobrazit více uživatelů s&nbsp;touto IP adresou',

// Moderate forum
'Moderate forum head'		=>	'Moderuje: %s',
'Topics'					=>	'Témata',
'Move topic'				=>	'Přesunout téma',
'Move topics'				=>	'Přesunout témata',
'Merge topics'				=>	'Spojit témata',
...
'Split posts'				=>	'Rozdělit vybrané příspěvky',
'Delete whole topic'		=>	'Odstranit celé téma',
'Moderate topic head'		=>	'Moderovat téma: %s',
'New subject'				=>	'Nový název tématu:',
'Select post'				=>	'Vybrat příspěvky',
'Confirm post delete'		=>	'Potvrdit odstranění všech vybraných příspěvků',
'Confirm topic delete'		=>	'Potvrdit odstranění všech vybraných témat',
